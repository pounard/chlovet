...
/******/ 	// The module cache
/******/ 	var installedModules = {};window.__exported = {};
/******/
...
/******/console.log("created module " + moduleId);console.log(module.exports);if (module.exports.Tween) { window.__exported[moduleId] = module.exports; }
...
window.Drupal = { 'settings': {}, 'behaviors': {}, 'locale': {} };
...
(function ($) {
  ...
  Drupal.ajax.prototype.commands = {
     ...
     */
    updateBuildId: function updateBuildId(ajax, response, status) {
  ...
  $.fn.dialog = function(options) {
    ...
    var close = function(destroy) {
      ...
      $msgbox.modal('hide').one('hidden.bs.modal', function() {
        if (destroy) {
          // don't really now why, but sometime this is not set
          if ($this.data(parentDataName)) {
            $this.data(parentDataName).append($this);
          }
          $msgbox.remove();

          // if another modals remains, set back the right behavior on the body
          var others = $body.find('.dialog'), last;
          if (others.length) {
              // Take one, any one
              last = others.last();
              last.isShown = false;
              last.modal('checkScrollbar');
              last.modal('setScrollbar');
    ...
    if (options.constructor == Object) {
      ...
      if (!$this.data(parentDataName)) {
        $this.data(parentDataName, $this.parent());
      }
