 ...
 */
function vetbase_form_user_login_alter(&$form, &$form_state) {
 ...
 * Implements hook_form_FORM_ID_alter().
 */
function vetbase_form_user_login_block_alter(&$form, &$form_state) {
  $form['name']['#title_force'] = true;
}
 ...
 * Implements hook_form_FORM_ID_alter().
 */
function vetbase_form_user_filter_form_alter(&$form, &$form_state) {
 ...
 * Implements hook_form_FORM_ID_alter().
 */
function vetbase_form_node_admin_content_alter(&$form, &$form_state) {
 ...
 */
function _vetbase_vertical_tabs_find($form, &$ret) {
  foreach (element_children($form) as $key) {
    if (isset($form[$key]['#type']) && 'vertical_tabs' === $form[$key]['#type']) {
      $ret[] = $key;
      _vetbase_vertical_tabs_find($form[$key], $ret);
    }
  }
}
 ...
 * collapsing on children.
 */
function _vetbase_vertical_tabs_recursion(&$form, $vertical_tabs = []) {
  ...
  foreach (element_children($form) as $key) {
    _vetbase_vertical_tabs_recursion($form[$key], $vertical_tabs);
  }
}
 ...
 */
function vetbase_vertical_tabs($variables) {
 ...
 */
function _vetbase_form_is_horizontal($set = null) {
 ...
 * Generic form alter.
 */
function vetbase_form_alter(&$form, &$form_state, $form_id) {
  $form['#after_build'][] = 'vetbase_form_after_build';
}

function vetbase_form_after_build(&$form, &$form_state) {
  if (isset($form['#form_horizontal'])) {
    _vetbase_form_is_horizontal($form['#form_horizontal']);
  } else {
    _vetbase_form_is_horizontal(false);
  }

  if (_vetbase_form_is_horizontal()) {
  ...
  $vertical_tabs = [];
  _vetbase_vertical_tabs_find($form, $vertical_tabs);
  _vetbase_vertical_tabs_recursion($form, $vertical_tabs);
 ...
 */
function vetbase_form($variables) {
  $element = $variables['element'];
 ...
 */
function vetbase_fieldset_filter_format($variables) {
  $element = &$variables['element'];
 ...
 */
function vetbase_fieldset($variables) {
  $element = &$variables['element'];
  ...
  if (isset($element['help']) && isset($element['format']) && isset($element['guidelines'])) {
    ...
    return vetbase_fieldset_filter_format($variables);
  }
 ...
 */
function vetbase_button($variables) {
  $element = $variables['element'];
 ...
 */
function vetbase_submit($variables) {
 ...
 */
function vetbase_preprocess_form_element(&$variables) {
  ...
  if (isset($element['#form_horizontal'])) {
    ...
    $is_horizontal = _vetbase_form_is_horizontal();
  }
 ...
 * Implements hook_preprocess_HOOK().
 */
function vetbase_preprocess_textfield(&$variables) {
  $element = &$variables['element'];
 ...
 * Implements hook_preprocess_HOOK().
 */
function vetbase_preprocess_textarea(&$variables) {
  $element = &$variables['element'];
  $element['#attributes']['class'][] = 'form-control';
}
 ...
 */
function vetbase_checkbox($variables) {
  $element = $variables['element'];
 ...
 */
function vetbase_radio($variables) {
  $element = $variables['element'];
 ...
 * Implements hook_preprocess_HOOK().
 */
function vetbase_preprocess_select(&$variables) {
  $element = &$variables['element'];
  $element['#attributes']['class'][] = 'form-control';
 ...
 */
function vetbase_password($variables) {
  $element = $variables['element'];
 ...
 */
function vetbase_tableselect($variables) {
  $element = $variables['element'];
  $rows = array();
 ...
 */
function _vetbase_colorize_button($text) {
